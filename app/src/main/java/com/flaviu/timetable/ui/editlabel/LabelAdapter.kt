...
class LabelAdapter(private val fragment: Fragment, private val database: CardDatabaseDao) :
...
class LabelHolder private constructor(private val binding: LabelCardBinding) :
    ...
    fun bind(label: Label, database: CardDatabaseDao, fragment: Fragment) {
        ...
        binding.delete.setOnClickListener {
            AlertDialog.Builder(fragment.requireContext())
                .setMessage("Are you sure you want to delete the label? It will also delete all cards which do not have other labels than this one")
